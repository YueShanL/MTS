...
model.set_generation_params(duration=30, cfg_coef=5)  # generate 8 seconds.
...
melody, sr = torchaudio.load('umxl.songTest.mp3.other.wav')

# generates using the melody from the given audio and the provided descriptions.
wav, token = model.generate_with_chroma(['solo,piano cover, rearrange'], melody[None].expand(1, -1, -1), sr, return_tokens=True)
