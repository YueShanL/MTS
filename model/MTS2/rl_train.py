...
from model.MTS2.RLTrainer import GRPOTrainer
...
from model.rl.trainer import RLConfig
...
class MTSReward:
    ...
    def calculate_reward(self, generated_sequence, target_midi, **kwargs):
        G, B = generated_sequence.shape[:2]
...
def train(
    ...
    trainer = GRPOTrainer(
        ...
        reward_function=reward.calculate_reward,
    )
